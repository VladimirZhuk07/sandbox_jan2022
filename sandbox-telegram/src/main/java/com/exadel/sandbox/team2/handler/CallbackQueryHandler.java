...
public class CallbackQueryHandler implements BaseHandler {
  ...
  public SendMessage handleSendMessage(Update update, User user) {
    ...
    switch (user.getTelegramState()){
      ...
      case ASSIGN_BOOKING_TYPE -> sendMessage = telegramService.setBookingType(chatId, "Please, select booking type", new String[][] {{"\uD83D\uDCC5 One day"},{"\uD83D\uDCC6 Continuous"},{"\uD83D\uDD04 Recurring"},{"\uD83D\uDD19"}}, new String[][] {{"One day"},{"Continuous"},{"Recurring"},{"Back"}}, data);
      case ONE_DAY_IS_WORKPLACE_ATTRIBUTES_NEED, CONTINUOUS_IS_WORKPLACE_ATTRIBUTES_NEED, RECURRING_IS_WORKPLACE_ATTRIBUTES_NEED -> sendMessage = telegramService.isWorkplaceNeedBeDefine(chatId, "Do you want to define office/workplace attributes?", new String[][]{{"☑️Yes","❌ No"},{"\uD83D\uDD19"}}, new String[][]{{"DEFINE_WORKPLACE_ATTRIBUTES", "NOT_DEFINE_WORKPLACE_ATTRIBUTES"},{"Back"}}, data);
      case ONE_DAY_IS_KITCHEN_NEED, CONTINUOUS_IS_KITCHEN_NEED, RECURRING_IS_KITCHEN_NEED -> sendMessage = telegramService.isKitchenNeed(chatId, "Should there be a kitchen?\nIf not, please press Next", new String[][]{{"Yes"},{"\uD83D\uDD19","⏩"}}, new String[][]{{"Yes"},{"Back","Next"}}, user, data);
      ...
      case IS_CONFERENCE_HALL_NEED -> sendMessage = telegramService.isConferenceHallNeed(chatId, "Should there be conference hall?\nIf not, then please press Next",
              new String[][]{{"Yes"},{"\uD83D\uDD19","⏩"}}, new String[][]{{"Yes"},{"Back","Next"}}, data);
      case IS_NEXT_TO_WINDOWS_NEED_BE -> sendMessage = telegramService.isNextToWindowNeedBe(chatId, "Should it be next to window?\nIf no, then please press No.\nIf does not matter then press Next",
              new String[][]{{"Yes","No"},{"\uD83D\uDD19","⏩"}}, new String[][]{{"Yes","No"},{"Back","Next"}}, data);
      ...
      case ONE_DAY_SELECT_DATE, CONTINUOUS_SELECT_DATE -> sendMessage = utils.getSendMessage(chatId, "Please write start date of your booking in form of `2022-03-10`", new String[][]{{"\uD83D\uDD19"}}, new String[][]{{"Back"}});
      case RECURRING_SELECT_WEEK_DAY -> sendMessage = utils.getSendMessage(chatId, "Please write all weekdays you want to book in the format 'MONDAY,TUESDAY,WEDNESDAY'", new String[][]{{"\uD83D\uDD19"}}, new String[][]{{"Back"}});
      case SHOW_OFFICES_BY_CITY -> sendMessage = telegramService.getOfficesByCityForOneDay(chatId, "Please enter office id", data, user, new String[][]{{"\uD83D\uDD19"}}, new String[][]{{"Back"}});
      case RECURRING_DEFINE_WEEKDAYS -> sendMessage = telegramService.defineRecurringWeekdays(chatId, "You want to book these weekdays ", data, new String[][] {{"\uD83D\uDD19"}}, new String[][] {{"Back"}}, user);
      case RECURRING_DEFINE_WEEKS -> sendMessage = telegramService.defineRecurringWeeks(chatId, "Please enter start date of your booking in the form of `2022-03-10`", data, new String[][] {{"\uD83D\uDD19"}}, new String[][] {{"Back"}}, user);
      ...
      case GET_USER_BOOKINGS -> sendMessage = telegramService.getUserBookings(chatId, "Here is your active bookings", user.getId(), new String[][]{{"\uD83D\uDEAB Cancel Booking"},{"\uD83D\uDD19"}}, new String[][]{{"CANCEL_BOOKING"},{"Back"}});
      case CANCEL_BOOKING -> sendMessage = utils.getSendMessage(chatId, "Please enter id of your booking to cancel it");
      case SELECT_END_DATE -> sendMessage = telegramService.setEndDateForContinuousBooking(chatId, "Please enter end date of your booking in the form of `2022-03-10`", data, user, new String[][]{{"\uD83D\uDD19"}}, new String[][]{{"Back"}});
      case SHOW_OFFICES_CONTINUOUS -> sendMessage = telegramService.getOfficesByCityForContinuous(chatId, "Please enter id of office", data, user, new String[][]{{"\uD83D\uDD19"}}, new String[][]{{"Back"}});
      case RECURRING_ASSIGN_START_WEEKDAY -> sendMessage = telegramService.defineRecurringStartDate(chatId, "Please write till what weekday you want to book in the form of 'MONDAY', only one weekday is allowed", data, user, new String[][] {{"\uD83D\uDD19"}}, new String[][] {{"Back"}});
      case RECURRING_ASSIGN_END_WEEKDAY -> sendMessage = telegramService.showRecurringOffices(chatId, "Please enter id of office", data, new String[][]{{"\uD83D\uDD19"}}, new String[][]{{"Back"}}, user);
      ...
      case REPORT -> sendMessage = telegramService.checkUserRole(chatId, "Please select report type.",
              new String[][]{{"User", "Employees"}, {"City", "Single Office"}, {"Offices", "Floor"}, {"\uD83D\uDD19"}},
              new String[][]{{"USER_REPORT", "ALL_USER_REPORT"}, {"CITY_REPORT", "SINGLE_OFFICE_REPORT"}, {"OFFICES_REPORT", "FLOOR_REPORT"}, {"Back"}}, user);
      case USER_REPORT_DEFINE_BOOKING_FROM -> sendMessage = utils.getSendMessage(chatId, "Please enter 'booking from' date in the form of '2022-03-21", new String[][]{{"\uD83D\uDD19"}}, new String[][]{{"Back"}});
      case ALL_USER_REPORT_DEFINE_CREATE_DATE_FROM -> sendMessage = utils.getSendMessage(chatId, "Please enter user`s 'created date' in the form of '2022-03-21'", new String[][]{{"\uD83D\uDD19"}}, new String[][]{{"Back"}});
      case ALL_OFFICE_REPORT_DEFINE_BOOKING_FROM -> sendMessage = utils.getSendMessage(chatId, "Please enter 'booking from' date in the form of '2022-03-21'", new String[][]{{"\uD83D\uDD19"}}, new String[][]{{"Back"}});
      case CITY_REPORT_DEFINE_ID -> sendMessage = utils.getSendMessage(chatId, "Please enter city name in uppercase", new String[][]{{"\uD83D\uDD19"}}, new String[][]{{"Back"}});
      case OFFICE_REPORT_DEFINE_ID -> sendMessage = telegramService.getOfficesByCity(chatId, "Please enter office id", null, new String[][]{{"\uD83D\uDD19"}}, new String[][]{{"Back"}}, null);
      case FLOOR_REPORT_DEFINE_FLOOR -> sendMessage = utils.getSendMessage(chatId, "Please enter floor number", new String[][]{{"\uD83D\uDD19"}}, new String[][]{{"Back"}});
      ...
      case EDIT_FIRSTNAME -> sendMessage = utils.getSendMessage(chatId,
              "Enter your new Firstname", new String[][]{{"\uD83D\uDD19"}}, new String[][]{{"Back"}});
      case EDIT_LASTNAME ->sendMessage = utils.getSendMessage(chatId,
              "Enter your new Lastname", new String[][]{{"\uD83D\uDD19"}}, new String[][]{{"Back"}});
      case EDIT_PASSWORD -> sendMessage = utils.getSendMessage(chatId,
              "Enter your new Password", new String[][]{{"\uD83D\uDD19"}}, new String[][]{{"Back"}});
